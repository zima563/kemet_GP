...
import { reviewRouter } from "./modules/review/reviewTrip.Routes.js";
...
import offerWishListRouter from "./modules/offerWL/offerWL.routes.js";
...
export const bootstrap = (app) => {
  ...
  app.use("/api/v1/offerWL",offerWishListRouter)
